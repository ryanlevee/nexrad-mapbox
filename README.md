...
This application fetches processed radar imagery and metadata from a custom backend (repo url above), displaying it as an overlay on the map. It provides intuitive controls for data selection, time-based animation, and (for specific products) tilt angle adjustments.
